...
void main() => runApp(ResultadoModulo1App());

class ResultadoModulo1App extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'resultado',
      theme: ThemeData(primarySwatch: Colors.deepPurple),
      home: ResultadoModulo1Page(),
    );
  }
}

class ResultadoModulo1Page extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ResultadoModulo1PageState();
  }
}

class _ResultadoModulo1PageState extends State<ResultadoModulo1Page> {
  get height => null;
