...
class VideoModulo6App extends StatelessWidget {
  @override
...
class VideoModulo6Page extends StatefulWidget {
  VideoModulo6Page({this.title, this.url});
  final String title;
  final url;
  @override
  State<StatefulWidget> createState() {
    return _VideoModulo6PageState();
  }
}

class _VideoModulo6PageState extends State<VideoModulo6Page> {
  //get height => null;
