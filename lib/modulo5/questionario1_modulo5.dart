...
import 'package:flutter_dinheirando/modulo5/questionario2_modulo5.dart';

void main() => runApp(Questionario1Modulo5App());

class Questionario1Modulo5App extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'questionario',
      theme: ThemeData(primarySwatch: Colors.deepPurple),
      home: Questionario1Modulo5Page(),
    );
  }
}
...
class Questionario1Modulo5Page extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _Questionario1Modulo5PageState();
  }
}

class _Questionario1Modulo5PageState extends State<Questionario1Modulo5Page> {
  get height => null;
