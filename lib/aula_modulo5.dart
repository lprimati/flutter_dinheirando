...
void main() => runApp(VideoModulo5App());

class VideoModulo5App extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Aulas',
      theme: ThemeData(primarySwatch: Colors.deepPurple),
      home: VideoModulo5Page(
        title: 'video de educaçao',
        url: 'https://www.youtube.com/watch?v=JHhzoWuHuAM',
      ),
    );
  }
}

class VideoModulo5Page extends StatefulWidget {
  VideoModulo5Page({this.title, this.url});
  final String title;
  final url;
  @override
  State<StatefulWidget> createState() {
    return _VideoModulo5PageState();
  }
}

class _VideoModulo5PageState extends State<VideoModulo5Page> {
  //get height => null;
